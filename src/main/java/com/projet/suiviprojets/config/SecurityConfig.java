    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers("/api/projets/**").hasAnyAuthority("ROLE_ADMINISTRATEUR", "ROLE_SECRETAIRE", "ROLE_CHEF_DE_PROJET")

                    // Chef de Projet & Comptable pour les phases
                    .requestMatchers("/api/phases/**").hasAnyAuthority("ROLE_PROJET_MANAGER", "ROLE_CHEF_DE_PROJET", "ROLE_COMPTABLE", "ROLE_ADMINISTRATEUR")

                    // Le CHEF DE PROJET pour affectations et livrables
                    .requestMatchers("/api/affectations/**", "/api/livrables/**").hasAnyAuthority("ROLE_CHEF_DE_PROJET", "ROLE_PROJET_MANAGER", "ROLE_ADMINISTRATEUR")
